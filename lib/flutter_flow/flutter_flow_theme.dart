...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF5605);
  late Color secondary = const Color(0xFF939BAD);
  late Color tertiary = const Color(0xFFEDEFF2);
  late Color alternate = const Color(0xFFDDE2E8);
  late Color primaryText = const Color(0xFF5E6275);
  late Color secondaryText = const Color(0xFF939BAD);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFAFAFA);
  late Color accent1 = const Color(0xFF7D8297);
  late Color accent2 = const Color(0xFFB1B9C8);
  ...
  late Color colorNeutral800 = const Color(0xFF5E6275);
}
