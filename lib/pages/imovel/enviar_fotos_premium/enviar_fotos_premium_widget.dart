...
import 'enviar_fotos_premium_model.dart';
export 'enviar_fotos_premium_model.dart';

class EnviarFotosPremiumWidget extends StatefulWidget {
  const EnviarFotosPremiumWidget({super.key});

  @override
  State<EnviarFotosPremiumWidget> createState() =>
      _EnviarFotosPremiumWidgetState();
}

class _EnviarFotosPremiumWidgetState extends State<EnviarFotosPremiumWidget> {
  late EnviarFotosPremiumModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnviarFotosPremiumModel());
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              'Para enviar as fotos, clique no botão abaixo para receber o link no seu e-mail cadastrado',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Text(
                                                    'Acesse o link enviado no seu e-mail para fazer o envio',
                                                    textAlign: TextAlign.center,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Se necessário, você pode clicar no link novamente e enviar novas fotos',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
